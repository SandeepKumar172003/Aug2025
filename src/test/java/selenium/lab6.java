...
public class lab6{
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("input-email")).sendKeys("8978sandeepkumar@gmail.com");
		driver.findElement(By.id("input-password")).sendKeys("sandy1");		
		...
		System.out.println("'Products marked with *** are not present in the desired quantity or not in stock!'");
